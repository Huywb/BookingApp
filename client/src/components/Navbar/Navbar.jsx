  ...
  return (
    <Box sx={{backgroundColor:"white",display:'flex',justifyContent:'space-between',alignItems:'center',paddingTop:'20px'}} >
        ...
        <Box className='p-1 px-2 flex border shadow-md rounded-full items-center'>
          ...
          <Box className='bg-red-400 p-1 rounded-full text-white'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
            <path stroke-linecap="round" stroke-linejoin="round" d="m15.75 15.75-2.489-2.489m0 0a3.375 3.375 0 1 0-4.773-4.773 3.375 3.375 0 0 0 4.774 4.774ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
          </svg>
          </Box>
        </Box>
        <Box className='p-1 flex justify-between gap-10 items-center '>
          <Box className='flex gap-4'>
            <Typography fontWeight='bold'>Airbnb your home</Typography>
